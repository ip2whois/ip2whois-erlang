...
myst_html_meta = {
    "description": "IP2WHOIS Erlang module enables user to easily implement the checking of WHOIS information for a particular domain into their solution using the API from www.ip2whois.com.",
    "keywords": "IP2WHOIS, whois, domain",
...
html_title = "IP2WHOIS Erlang SDK"

# html_baseurl = "https://ip2whois-erlang.readthedocs.io/en/latest/"